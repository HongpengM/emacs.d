...
(use-package nyan-mode
  :ensure t
  :config (setq nyan-animation-frame-interval 0.1)(setq nyan-bar-length 20)(setq nyan-wavy-trail t)(nyan-mode)(nyan-start-animation))
...
(use-package smart-mode-line
  :ensure t
  :config (setq sml/shorten-modes t)(setq sml/shorten-directory t)(setq sml/name-width 20)(setq sml/mode-width 'full)(setq sml/hidden-modes nil)(setq sml/theme nil)(add-to-list 'sml/hidden-modes " Anzu")(add-to-list 'sml/hidden-modes " AC")(add-to-list 'sml/hidden-modes " yas")(add-to-list 'sml/hidden-modes " pair")(add-to-list 'sml/hidden-modes " FIC")(add-to-list 'sml/hidden-modes " Abbrev")(add-to-list 'sml/hidden-modes " ARev")(add-to-list 'sml/hidden-modes " SliNav")(add-to-list 'sml/hidden-modes " ElDoc")(add-to-list 'sml/hidden-modes " company")(add-to-list 'sml/hidden-modes " overseer")(add-to-list 'sml/hidden-modes " Guide")(sml/setup))
...
(use-package kaolin-themes
  ...
  :requires smart-mode-line
  :defer t
  :init (add-theme 'kaolin-dark)(add-theme 'kaolin-ocean)(add-theme 'kaolin-eclipse))
...
(use-package sublime-themes
  ...
  :requires smart-mode-line
  :defer t
  :init (add-theme 'junio)(add-theme 'wilson))
...
(use-package rainbow-delimiters
  :ensure t
  :demand t
  :config (add-hook 'prog-mode 'rainbow-delimiters-m))
;; rainbow-mode
